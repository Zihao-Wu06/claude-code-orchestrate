...
- **Start your final message with a status:** `DONE | DONE_WITH_CONCERNS | NEEDS_CONTEXT | BLOCKED`. A surfaced design decision is `NEEDS_CONTEXT` naming the decision; never silently deliver work you are unsure about.
